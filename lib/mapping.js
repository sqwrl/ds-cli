...
// TODO: generate and post an elasticsearch mapping file for each index to get correct datatypes for date, float, integer. Also for creating .raw fields that can be returned in aggregates so that the facets display proper (non-lowercase) values
var fs      = require('fs'),
    async   = require('async'),
 ...
 * @param {Function} callback - callback function when operation complete
 */
// TODO: replace by using elasticsearch parent/child relations? Or nesting?

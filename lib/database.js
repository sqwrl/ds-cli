 ...
 *      params.query is the query string
 *      params.idList is a list a comma separated string with records ids
 *      params.orderBy is a string of a field name to order the results by
...
module.exports.query = function(
    ...
    if (params.orderBy) {
        newQuery += ' ORDER BY ' + params.orderBy;
        if (offSet >= 0 && next > 0) {
            newQuery += ' ASC OFFSET ' + offSet + ' ROWS FETCH NEXT ' + next + ' ROWS ONLY';
        }
    }
